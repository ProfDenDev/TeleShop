...
# from sqlalchemy import select
#
# from app.database.models.product_photo import (ProductPhoto)
#
...
#         Получить все фотографии товара.
#         """
#         stmt = (select(ProductPhoto)
#             .where(ProductPhoto.product_id
#                 == product_id)
...
#
#
#     async def has_photos(self, product_id: int) -> bool:
#         """
#         Есть ли фото у товара.
#         """
#         photos = await (self.get_by_product_id(product_id))
#         return len(photos) > 0
#
#     async def count_photos(self, product_id: int) -> int:
#         """
#         Количество фото товара.
#         """
#
...
#         return len(photos)
#
#     async def can_add_photo(self, product_id: int) -> bool:
#         """
#         Проверка лимита фотографий.
#         """
#
#         count = await self.count_photos(product_id)
#         return (count < MAX_PRODUCT_PHOTOS)
#
#     async def get_products_without_photos(self):
#         """
#         Товары без фотографий.
#         """
#
#         stmt = select(ProductPhoto.product_id)
#
#         result = await self.session.execute(stmt)
#
#         product_ids = {
...
#         return product_ids
#
#     async def get_main_photo(self, product_id: int):
#         """
#         Главное фото товара.
#
#         Главное фото всегда имеет:
#         position = 0
#         """
#
#         stmt = (select(ProductPhoto)
#             .where(ProductPhoto.product_id == product_id,
#                 ProductPhoto.position == 0
#             )
#         )
#
#         result = await self.session.execute(stmt)
